...
// Get total records
$total_query = "SELECT COUNT(*) as total FROM hasil_produksi WHERE user_id = $user_id";
...
$stat_query = "SELECT 
                ...
                SUM(jumlah_hasil) as total_berat,
                AVG(jumlah_hasil) as rata_rata,
                SUM(CASE WHEN kondisi_mesin = 'Baik' THEN 1 ELSE 0 END) as mesin_baik,
                SUM(CASE WHEN kondisi_mesin = 'Perlu Maintenance' THEN 1 ELSE 0 END) as perlu_maintenance,
                SUM(CASE WHEN kondisi_mesin = 'Rusak' THEN 1 ELSE 0 END) as mesin_rusak
               FROM hasil_produksi 
               WHERE user_id = $user_id";
...
<head>
    ...
    <title>Riwayat Produksi - SIP Pengolahan Plastik</title>
...
<body>
    ...
    <div class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li><a href="riwayat_produksi.php" class="active"><i class="fas fa-history"></i> Riwayat Produksi</a></li>
    ...
    <div class="content">
        <div class="page-header">
            <div>
                ...
                <p>Daftar lengkap produksi yang pernah Anda catat</p>
            </div>
            <a href="hasil_produksi.php" class="btn-tambah">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-value"><?php echo $stats['total_produksi'] ?? 0; ?></div>
            ...
            <div class="stat-card">
                <div class="stat-value"><?php echo $stats['mesin_baik'] ?? 0; ?></div>
                <div class="stat-label">Mesin Baik</div>
            </div>
            <div class="stat-card">
                <div class="stat-value"><?php echo $stats['perlu_maintenance'] ?? 0; ?></div>
                <div class="stat-label">Perlu Maintenance</div>
            </div>
            <div class="stat-card">
                <div class="stat-value"><?php echo $stats['mesin_rusak'] ?? 0; ?></div>
                <div class="stat-label">Mesin Rusak</div>
            </div>
        </div>

        <div class="table-container">
            <h3><i class="fas fa-history"></i> Riwayat Produksi</h3>
                ...
                <tbody>
                    <?php if($result && $result->num_rows > 0): ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo number_format($row['jumlah_hasil'], 2); ?> kg</td>
                            <td>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="9" style="text-align: center; color: #999; padding: 40px;">
                                ...
                                Belum ada data produksi. Silakan tambah data di menu Hasil Produksi.
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
